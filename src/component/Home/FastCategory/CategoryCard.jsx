...
const CategoryCard = () => {
  return (
   <>
                  <Flex borderRight={'0.5px solid'} borderColor={'gray.200'}  _hover={{color:'red', boxShadow:'2xl'}} as={Link} to={'/free-delivery'} alignItems={'center'} >
                    <VStack alignItems={'center'} justifyContent={'center'} py={2} px={2} bg={"#ffffff"} w={{base:'110px',md:'123px'}}>
                        <Box  w={{base:"60px",md:"75px"}}>
                            <Image w={'full'} h={'full'} src={"https://icms-image.slatic.net/images/ims-web/0072753b-e061-432c-8bda-accf097e9fd6.png"} />
                        </Box>
